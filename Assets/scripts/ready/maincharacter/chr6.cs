...
public class chr6 : character
{
    ...
    void Update()
    {
        if (readyprocess.maincharacternum == 6)
        {
        ...
        else if (readyprocess.nextscene == readyprocess.NextScene.END && readyprocess.maincharacternum == 6)
        {
