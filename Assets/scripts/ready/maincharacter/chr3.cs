...
public class chr3 : character
{
    ...
    void Update()
    {
        if (readyprocess.maincharacternum == 3)
        {
        ...
        else if (readyprocess.nextscene == readyprocess.NextScene.END && readyprocess.maincharacternum == 3)
        {
