...
public class chr4 : character {
    ...
    void Update()
    {
        if (readyprocess.maincharacternum == 4)
        {
        ...
        else if (readyprocess.nextscene == readyprocess.NextScene.END && readyprocess.maincharacternum == 4)
        {
